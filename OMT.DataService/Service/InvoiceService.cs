        ...
        public ResultDTO GetInvoice(GetInvoiceDTO getinvoiceDTO)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    // find duplicatecheck columns for skillsetname

                    //var defcol1 = (from def in _oMTDataContext.DefaultTemplateColumns
                    //               where def.IsActive == true && def.IsDuplicateCheck == true && def.SystemOfRecordId == isinvoiceskillset.SystemofRecordId
                    //               select def.DefaultColumnName).ToList();
