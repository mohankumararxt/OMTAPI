...
namespace PendingSciOrders_5pm
{
    ...
    internal class Program
    {
        ...
        public static void SetSciOrdersToPending_5pm()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string SciSkillsets = @"SELECT DISTINCT SS.SkillSetId, SS.SystemofRecordId ,SS.SkillsetName,PS.Id
                                            ...
                                            WHERE SS.isactive = 1 AND PS.Status = 'System-Pending'  AND SPS.IsActive =1 AND SPS.Scheduled_Time = @ScheduledTime AND SPS.Scheduled_Days = 'Sat'
                                            ORDER BY SkillSetId";
